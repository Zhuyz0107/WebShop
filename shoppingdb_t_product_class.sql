...
LOCK TABLES `t_product_class` WRITE;
/*!40000 ALTER TABLE `t_product_class` DISABLE KEYS */;
INSERT INTO `t_product_class` VALUES (1,'服装'),(2,'计算机'),(3,'手机');
/*!40000 ALTER TABLE `t_product_class` ENABLE KEYS */;
UNLOCK TABLES;
